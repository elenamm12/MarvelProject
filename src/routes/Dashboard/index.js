        ...
        <div>
            <Grid className={classes.main}>
                <Grid className={classes.titleBox}>
                    <Typography className={classes.title}>MARVEL UNIVERSE</Typography>
                    <Typography className={classes.subtitle}>A Walt Disney Studios' subsidiary film and television production company</Typography>
                </Grid>
